...
main()
{
    ...
    cin >> hasClima;
    cout << boolalpha << (!isNewOrOld && (hasClima == true) && mileage < 115000 && power >= 70 && price <= 6000) || (!isNewOrOld || (hasClima == false) && mileage < 180000 && power >= 60 && price <= 2000) || (isNewOrOld) && power >= 70 && power <= 90 && price <= 25000;
